		...
		const scenarios: Scenario[] = [
			{
				day: 0,
				prompt:
					"You are a single parent with two school-going children, living in a one-room rental flat. You are without a job and down to your last $150. Can you make it through the next two weeks?",
